***********************************************************************************************************************************************************************************;
*Purpose: Perform TCIC backward elimination with time information and without using Competing-risk for BS datasets by outcome: DEATH                                               ;                                     
...
*Only use 100 BS samples and outcome='death';
data bsdata;
 set savedata.clinical_bs500_gdr_20210707;
 where 0<replicate<=100 and outcome="death";
proc sort; by newid; run;
/* 664600 observations and 5 variables */
...
/* 664600 observations and 153+4=157 variables */
...
%let DATA=bsdata3;
%let NORMWGT= normwgt_death; /*normalized weight variables for each outcome*/
