***********************************************************************************************************************************************************************************;
*Purpose: Perform TCIC backward elimination with time information and without using Competing-risk for BS datasets by outcome: WALK                                                ;                                     
...
*Only use 100 BS samples and outcome='walk';
data bsdata;
 set savedata.clinical_bs500_gdr_20210707;
 where 0<replicate<=100 and outcome="walk";
proc sort; by newid; run;
/* 640900 observations and 5 variables */
...
/* 640900 observations and 153+4=157 variables */
...
%let DATA=bsdata3;
%let NORMWGT= normwgt_walk; /*normalized weight variables for each outcome*/
